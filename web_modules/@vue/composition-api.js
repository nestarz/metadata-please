...
function mergeData$1(to, from) {
    ...
    for (var i = 0; i < keys.length; i++) {
        ...
        if (!hasOwn$1(to, key)) {
            ...
            (isPlainObject$1(toVal) && !isRef(toVal)) &&
            (isPlainObject$1(fromVal) && !isRef(toVal))) {
...
function resolveScopedSlots$1(vm, slotsProxy) {
    ...
    var curSlots = resolveSlots$1(parentVode.data.scopedSlots, vm.$slots);
    // remove staled slots
...
export { computed, createComponent$1 as createComponent, createElement$2 as createElement, inject, isRef, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onUnmounted, onUpdated, provide, reactive, ref$1 as ref, set$1 as set, toRefs, watch };
