...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"web_modules/chrome-extension-async.js":[function(require,module,exports) {
...
(function () {
  ...
  function promisify(f, parseCB) {
    return (...args) => {
      let safeArgs = args;
      let callback; // The Chrome API functions all use arguments, so we can't use f.length to check
  ...
  function applyMap(api, apiMap) {
    ...
    for (let funcDef of apiMap) {
      ...
      if (typeof m === 'function') // This is a function, wrap in a promise
        api[funcName] = promisify(m.bind(api), funcDef.cb);else // Sub-API, recurse this func with the mapped props
  ...
  const knownInContentSetting = ['clear', 'get', 'set', 'getResourceIdentifiers']; // StorageArea https://developer.chrome.com/extensions/storage#type-StorageArea
...
},{}],"web_modules/common/_commonjsHelpers-2ffd9a0d.js":[function(require,module,exports) {
...
},{}],"web_modules/yamljs/dist/yaml.min.js":[function(require,module,exports) {
"use strict";
...
var _commonjsHelpers2ffd9a0d = require("../../common/_commonjsHelpers-2ffd9a0d.js");

(function e(t, n, i) {
  function r(l, u) {
    if (!n[l]) {
      if (!t[l]) {
        var a = typeof _commonjsHelpers2ffd9a0d.c == "function" && _commonjsHelpers2ffd9a0d.c;
        if (!u && a) return a(l, !0);
        if (s) return s(l, !0);
  ...
  var s = typeof _commonjsHelpers2ffd9a0d.c == "function" && _commonjsHelpers2ffd9a0d.c;
  ...
  7: [function (e, t, n) {
    ...
    l = function () {
      ...
      e.prototype.parse = function (t, n, s) {
        var l, u, o, f, c, h, p, A, L, d, N, g, R, x, C, I, m, S, w, v, y, P, b, D, O, M, G, U, X, F, k, H, j, Y, B, Q;
...
var yaml_min = {};
var _default = yaml_min;
exports.default = _default;
},{"../../common/_commonjsHelpers-2ffd9a0d.js":"web_modules/common/_commonjsHelpers-2ffd9a0d.js"}],"node_modules/vue/dist/vue.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
 * Vue.js v2.6.10
...
},{}],"web_modules/@vue/composition-api.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
function nonReactive(obj) {
  ...
  obj.__ob__ = observe$1({}).__ob__; // mark as nonReactive
...
function set$1(target, key, val) {
  ...
  if (isArray(target) && isValidArrayIndex$1(key)) {
    target.length = Math.max(target.length, key);
    target.splice(key, 1, val);
    return val;
  }
...
function mergeData$1(to, from) {
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    if (!hasOwn$1(to, key)) {
      to[key] = fromVal;
    } else if (toVal !== fromVal && isPlainObject$1(toVal) && !isRef(toVal) && isPlainObject$1(fromVal) && !isRef(toVal)) {
...
var createElement$2 = function createElement() {
  var args = [];
...
function createComponent$1(options) {
  return options;
}
...
function resolveInject$1(provideKey, vm) {
  var source = vm;
...
function inject(key, defaultValue) {
  ...
  var val = resolveInject$1(key, vm);
...
},{}],"web_modules/vue-simple-suggest.js":[function(require,module,exports) {
...
var VueSimpleSuggest = {
  render: function () {
    ...
    return _c('div', {
      ...
      class: [_vm.styles.vueSimpleSuggest, {
        designed: !_vm.destyled,
        focus: _vm.isInFocus
      }],
      on: {
      ...
      attrs: {
        ...
        "aria-expanded": !!_vm.listShown && !_vm.removeList ? 'true' : 'false'
      }
    ...
    }, 'input', _vm.$attrs, false))])], 2), _vm._v(" "), _c('transition', {
      attrs: {
        "name": "vue-simple-suggest"
      }
    }, [!!_vm.listShown && !_vm.removeList ? _c('ul', {
    ...
    }, [!!this.$scopedSlots['misc-item-above'] ? _c('li', [_vm._t("misc-item-above", null, {
      "suggestions": _vm.suggestions,
      "query": _vm.text
    })], 2) : _vm._e(), _vm._v(" "), _vm._l(_vm.suggestions, function (suggestion, index) {
      return _c('li', {
        key: _vm.getId(suggestion, index),
        staticClass: "suggest-item",
        class: [_vm.styles.suggestItem, {
          selected: _vm.isSelected(suggestion),
          hover: _vm.isHovered(suggestion)
        }],
        attrs: {
          "role": "option",
          "aria-selected": _vm.isHovered(suggestion) || _vm.isSelected(suggestion) ? 'true' : 'false',
      ...
      }, [_vm._t("suggestion-item", [_c('span', [_vm._v(_vm._s(_vm.displayProperty(suggestion)))])], {
    ...
    }), _vm._v(" "), !!this.$scopedSlots['misc-item-below'] ? _c('li', [_vm._t("misc-item-below", null, {
      "suggestions": _vm.suggestions,
      "query": _vm.text
    })], 2) : _vm._e()], 2) : _vm._e()])], 1);
  },
  ...
  watch: {
    mode: {
      handler(current, old) {
        this.constructor.options.model.event = current; // Can be null if the component is root
  ...
  methods: {
    ...
    onKeyDown(e) {
      const select = this.controlScheme.select,
            hideList = this.controlScheme.hideList; // prevent form submit on keydown if Enter key registered in the keyup list
    ...
    suggestionClick(suggestion, e) {
      ...
      this.select(suggestion); /// Ensure, that all needed flags are off before finishing the click.
    ...
    onFocus(e) {
      ...
      this.isFalseFocus = false; // Show list only if the item has not been clicked
      ...
      return _finally(function () {
        return _catch(function () {
          return _invokeIgnored(function () {
            if (_this2.canSend) {
              _this2.canSend = false; // @TODO: fix when promises will be cancelable (never :D)
    ...
    getSuggestions: _async(function (value) {
      ...
      _this3.selected = null; // Start request if can
...
var _default = VueSimpleSuggest;
exports.default = _default;
},{"process":"../../../.config/yarn/global/node_modules/process/browser.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _default = Vue;
exports.default = _default;
},{}],"popup/Popup.vue":[function(require,module,exports) {
//
//
//
//
...
const removeEmpty = obj => Object.entries(obj).reduce((a, [k, v]) => v || v === 0 ? { ...a,
  [k]: v
} : a, {});
...
module.exports = {
  setup() {
    ...
    const cities = ref([]);
    const countries = ref([]);
    fetch("/assets/json/options.json").then(response => response.json()).then(async json => {
      const {
        options
    ...
    fetch("/assets/json/cities10000.json").then(response => response.json()).then(json => {
    ...
    return {
      ...
      gooption: () => browser.runtime.openOptionsPage()
        ...
        var $d6e20d = exports.default || module.exports;
      
      if (typeof $d6e20d === 'function') {
        $d6e20d = $d6e20d.options;
      }
    
        /* template */
        Object.assign($d6e20d, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    "form",
    {
      ...
      on: {
        submit: function($event) {
          ...
          return _vm.submit(_vm.mode, _vm.git, _vm.download)
        }
      }
    },
    [
      _c("header", [
        ...
        _vm._v(" "),
        _c("nav", { attrs: { tabindex: "0" } }, [
          _c("span", [_vm._v("Menu")]),
          _vm._v(" "),
          _c("a", { attrs: { href: "#" }, on: { click: _vm.clear } }, [
            _vm._v("Clear Cache")
          ]),
          _vm._v(" "),
          _c("a", { attrs: { href: "#" }, on: { click: _vm.gooption } }, [
            _vm._v("Options")
          ])
        ])
      ]),
      ...
      _c(
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.config.project,
              expression: "config.project"
            }
          ],
          attrs: { required: "" },
          on: {
        ...
        _vm._l(_vm.projects, function(project) {
          return _c("option", { key: project }, [_vm._v(_vm._s(project))])
        }),
        0
      ),
      _vm._v(" "),
      ...
      _c(
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.config.category,
              expression: "config.category"
            }
          ],
          attrs: { required: "" },
          on: {
        ...
        _vm._l(_vm.categories, function(category) {
          return _c("option", { key: category }, [_vm._v(_vm._s(category))])
        }),
        0
      ),
      _vm._v(" "),
      ...
      _c("input", {
        ...
        attrs: {
          type: "text",
          placeholder: "https://eliasrhouzlane.com/",
          required: ""
        },
      ...
      _c("input", {
        ...
        attrs: { type: "text", placeholder: "eliaspourquoi", required: "" },
        domProps: { value: _vm.config.title },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
      ...
      _c("input", {
        ...
        attrs: { type: "text", placeholder: "Elias Rhouzlane" },
        domProps: { value: _vm.config.author },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.config, "author", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.config.alias,
            expression: "config.alias"
          }
        ],
        attrs: { type: "text", placeholder: "Billy the kid" },
        domProps: { value: _vm.config.alias },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.config, "alias", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      ...
      _c("suggest", {
        ...
        model: {
          value: _vm.config.location.city,
          callback: function($$v) {
            _vm.$set(_vm.config.location, "city", $$v)
          },
          expression: "config.location.city"
        }
      }),
      _vm._v(" "),
      ...
      _c("suggest", {
        ...
        model: {
          value: _vm.config.location.country,
          callback: function($$v) {
            _vm.$set(_vm.config.location, "country", $$v)
          },
          expression: "config.location.country"
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.config.organization,
            expression: "config.organization"
          }
        ],
        attrs: { type: "text", placeholder: "Design Academy Eindhoven" },
        domProps: { value: _vm.config.organization },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.config, "organization", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      ...
      _c(
        ...
        [
          _c("span", [_vm._v("Tags")]),
          _vm._v(" "),
          _vm._l(_vm.config.tags, function(tag) {
            return _c("div", { key: tag }, [_vm._v(_vm._s(tag))])
          })
        ],
        2
      ),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.config.tags,
              expression: "config.tags"
            }
          ],
          attrs: { multiple: "", id: "tags", size: "9", required: "" },
          on: {
            change: function($event) {
              var $$selectedVal = Array.prototype.filter
                .call($event.target.options, function(o) {
      ...
      _vm._v(" "),
      _c("label", { attrs: { for: "interest" } }, [_vm._v("Interest")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.config.interest,
            expression: "config.interest"
          }
        ],
        attrs: {
          type: "range",
        ...
        domProps: { value: _vm.config.interest },
        on: {
          __r: function($event) {
            return _vm.$set(_vm.config, "interest", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      ...
      _c("div", { staticClass: "copy" }, [
        _c("textarea", {
          ...
          ref: "yamlArea",
          attrs: { tabindex: "0", readonly: "" },
          domProps: { value: _vm.yaml },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.yaml = $event.target.value
            }
          }
        }),
        _vm._v(" "),
        _c("span", [
          ...
          _c(
            "a",
            { ref: "git", attrs: { href: _vm.gitpage, target: "_blank" } },
            [_vm._v("Commit @ Git")]
          )
        ])
      ]),
      ...
      _c("a", {
        ...
        attrs: {
          href:
            "data:text/x-yaml;charset=utf-8," + encodeURIComponent(_vm.yaml),
          download: _vm.config.slug + ".yml"
        }
      })
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d6e20d', $d6e20d);
          } else {
            api.reload('$d6e20d', $d6e20d);
          }
        }
...
},{"_css_loader":"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"popup.js":[function(require,module,exports) {
"use strict";

require("/web_modules/chrome-extension-async.js");

require("/web_modules/yamljs/dist/yaml.min.js");

var _vue = _interopRequireDefault(require("vue/dist/vue.js"));

var _compositionApi = _interopRequireWildcard(require("/web_modules/@vue/composition-api.js"));

var _vueSimpleSuggest = _interopRequireDefault(require("/web_modules/vue-simple-suggest.js"));

var _Popup = _interopRequireDefault(require("/popup/Popup.vue"));
...
// const popup = httpVueLoader("/popup/Popup.vue");
_vue.default.use(_compositionApi.default);

_vue.default.component("suggest", _vueSimpleSuggest.default);

const composition = {
  ref: _compositionApi.ref,
  reactive: _compositionApi.reactive,
  computed: _compositionApi.computed,
  watch: _compositionApi.watch,
  onMounted: _compositionApi.onMounted
};
...
},{"/web_modules/chrome-extension-async.js":"web_modules/chrome-extension-async.js","/web_modules/yamljs/dist/yaml.min.js":"web_modules/yamljs/dist/yaml.min.js","vue/dist/vue.js":"node_modules/vue/dist/vue.js","/web_modules/@vue/composition-api.js":"web_modules/@vue/composition-api.js","/web_modules/vue-simple-suggest.js":"web_modules/vue-simple-suggest.js","/popup/Popup.vue":"popup/Popup.vue"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
